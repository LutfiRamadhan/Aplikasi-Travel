        ...
        <div class="card">
            ...
            <div class="card-body">
                <div class="card-block">
                    ...
                    @endif
                    <form action="{{ url('transaksi/'.$transaksi->id) }}" method="post" class="form-horizontal">
                        <div class="form-group row">
                            <label for="number_transaction" class="label-control col-md-3">
                                NO. TRANSAKSI :
                            </label>
                            <div class="col-md-9">
                                <input type="text" id="number_transaction" class="form-control" required data-validation-required-message="Nomor Transaksi harus diisi" value="{{ $transaksi->no_transaction }}" disabled>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-9">
                                <input type="text" id="nama_penumpang" name="nama_penumpang" class="form-control" required placeholder="Masukan Nama Penumpang" data-validation-required-message="Nama Penumpang harus diisi" value="{{ $transaksi->nama_penumpang }}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-9">
                                <select name="seat_number" id="seat_number" class="form-control" required data-validation-required-message="Seat Number harus diisi">
                                    <option value="{{ $transaksi->seat_number }}" selected>{{ $transaksi->seat_number }}</option>
                            ...
                            <div class="col-md-9">
                                <select name="status" id="status" class="form-control" required data-validation-required-message="Status harus diisi">
                                    ...
                                    @foreach ($status as $item)
                                        {{ (var_dump($item)).(var_dump($transaksi->status)) }}
                                        <option value="{{ $item }}" {{ ($item == $transaksi->status)?'selected':'' }}>{{ $item }}</option>
                                    @endforeach
                                </select>
